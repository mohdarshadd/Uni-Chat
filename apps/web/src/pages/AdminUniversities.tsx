...
export function AdminUniversities() {
  ...
  return (
    <AdminLayout activePath="/admin/universities">
      <button
      ...
      <div className="glass mb-8 rounded-xl border border-[var(--color-border)] p-4">
        ...
        <div className="flex flex-col gap-3 sm:flex-row">
          ...
          <Button onClick={handleAdd} disabled={!newName || !selectedCity} className="sm:self-start">
        ...
        {universities.map((uni) => (
          ...
          >
            <div className="min-w-0 pr-3">
              <p className="truncate text-sm font-medium text-[var(--color-text)]">{uni.name}</p>
